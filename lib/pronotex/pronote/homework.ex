defmodule Pronotex.Pronote.Homework do
  ...
  defstruct [:id, :child_id, :subject, :color, :description, :date, done: false, resources: []]
  ...
  def parse(raw, child_id, transport \\ nil) do
    content = Pronotex.Pronote.LessonContent.parse(raw, transport)
